...
void arrayListPrintInfo(ArrayList *arrayList) {
    printf("Size = %d, Element Size = %zu, Internal Index = %d, Max Count = %zu\n",
           arrayList->size(arrayList), arrayList->_elementSize, arrayList->_index, arrayList->_maxCount);
}
...
ArrayList *arrayListNew(size_t elementSize)  {
    ...
    arrayList->insert = arrayListInsert;
    arrayList->replace = arrayListReplace;
    arrayList->remove = arrayListRemove;
    arrayList->get = arrayListGet;
    arrayList->printInfo = arrayListPrintInfo;
    arrayList->delete = arrayListDelete;
    return arrayList;
}